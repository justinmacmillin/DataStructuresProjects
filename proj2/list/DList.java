...
public class DList {
  ...
  protected DListNode head, currNode;
  protected int size;
   ...
   */
	...
	public DListNode next() {
		DListNode temp = next(currNode);
		currNode = currNode.next;
		return temp;
	}
	
	public boolean hasNext() {
		return next(currNode) != null;
	}

  public DListNode next(DListNode node) {
    // Your solution here.
	return ( (node==null) || (node.next == head))? null: node.next; 
  }
  ...
  public DListNode prev(DListNode node) {
    // Your solution here.
	return ((node.prev == head) || (node == null) )? null: node.prev;
  }
